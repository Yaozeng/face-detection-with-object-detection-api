...
import object_detection.protos.anchor_generator_pb2 as anchor__generator__pb2
import object_detection.protos.box_coder_pb2 as box__coder__pb2
import object_detection.protos.box_predictor_pb2 as box__predictor__pb2
import object_detection.protos.hyperparams_pb2 as hyperparams__pb2
import object_detection.protos.image_resizer_pb2 as image__resizer__pb2
import object_detection.protos.matcher_pb2 as matcher__pb2
import object_detection.protos.losses_pb2 as losses__pb2
import object_detection.protos.post_processing_pb2 as post__processing__pb2
import object_detection.protos.region_similarity_calculator_pb2 as region__similarity__calculator__pb2
...
_SSD.fields_by_name['image_resizer'].message_type = image__resizer__pb2._IMAGERESIZER
_SSD.fields_by_name['feature_extractor'].message_type = _SSDFEATUREEXTRACTOR
_SSD.fields_by_name['box_coder'].message_type = box__coder__pb2._BOXCODER
_SSD.fields_by_name['matcher'].message_type = matcher__pb2._MATCHER
_SSD.fields_by_name['similarity_calculator'].message_type = region__similarity__calculator__pb2._REGIONSIMILARITYCALCULATOR
_SSD.fields_by_name['box_predictor'].message_type = box__predictor__pb2._BOXPREDICTOR
_SSD.fields_by_name['anchor_generator'].message_type = anchor__generator__pb2._ANCHORGENERATOR
_SSD.fields_by_name['post_processing'].message_type = post__processing__pb2._POSTPROCESSING
_SSD.fields_by_name['loss'].message_type = losses__pb2._LOSS
_SSDFEATUREEXTRACTOR.fields_by_name['conv_hyperparams'].message_type = hyperparams__pb2._HYPERPARAMS

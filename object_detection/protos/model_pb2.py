...
import object_detection.protos.faster_rcnn_pb2 as faster__rcnn__pb2
import object_detection.protos.ssd_pb2 as ssd__pb2
...
_DETECTIONMODEL.fields_by_name['faster_rcnn'].message_type = faster__rcnn__pb2._FASTERRCNN
_DETECTIONMODEL.fields_by_name['ssd'].message_type = ssd__pb2._SSD

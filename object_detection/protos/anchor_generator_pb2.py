...
import object_detection.protos.grid_anchor_generator_pb2 as grid__anchor__generator__pb2
import object_detection.protos.ssd_anchor_generator_pb2 as ssd__anchor__generator__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='anchor_generator.proto',
  package='object_detection.protos',
  syntax='proto2',
  serialized_pb=_b('\n\x16\x61nchor_generator.proto\x12\x17object_detection.protos\x1a\x1bgrid_anchor_generator.proto\x1a\x1assd_anchor_generator.proto\"\xc7\x01\n\x0f\x41nchorGenerator\x12M\n\x15grid_anchor_generator\x18\x01 \x01(\x0b\x32,.object_detection.protos.GridAnchorGeneratorH\x00\x12K\n\x14ssd_anchor_generator\x18\x02 \x01(\x0b\x32+.object_detection.protos.SsdAnchorGeneratorH\x00\x42\x18\n\x16\x61nchor_generator_oneof')
  ,
  dependencies=[grid__anchor__generator__pb2.DESCRIPTOR,ssd__anchor__generator__pb2.DESCRIPTOR,])
...
_ANCHORGENERATOR.fields_by_name['grid_anchor_generator'].message_type = grid__anchor__generator__pb2._GRIDANCHORGENERATOR
_ANCHORGENERATOR.fields_by_name['ssd_anchor_generator'].message_type = ssd__anchor__generator__pb2._SSDANCHORGENERATOR
...
AnchorGenerator = _reflection.GeneratedProtocolMessageType('AnchorGenerator', (_message.Message,), dict(
  ...
  __module__ = 'anchor_generator_pb2'
